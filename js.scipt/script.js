...
let count = 0;
let storecount = 0;
let classicspoonCount=localStorage.getItem('classicspooncount') || 0;
let chocolatespoonCount=localStorage.getItem('chocolatespoonCount') ||0;
let classicforkCount=localStorage.getItem('classicforkCount') ||0;
let chocolateforkCount=localStorage.getItem('chocolateforkCoun') ||0;
let classicbowlCount=localStorage.getItem('classicbowlCount') ||0;
let chocolatebowlCount=localStorage.getItem('chocolatebowlCount') ||0;
